      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="total-frame">
            <i :class="icon.img_home_order" class="total-icon"></i>
        ...
        <el-col :span="8">
          <div class="total-frame">
            <i :class="icon.img_home_today_amount" class="total-icon"></i>
        ...
        <el-col :span="8">
          <div class="total-frame">
            <i :class="icon.img_home_yesterday_amount" class="total-icon"></i>
...
export default {
  ...
  data() {
    return {
      icon:{
        img_home_order:"el-icon-s-order",
        img_home_today_amount:"fa fa-dollar",
        img_home_yesterday_amount:"fa fa-dollar"
      }
    };
  },
};
